...
AUTH_PROFILE_MODULE = 'dirapp.UserProfile' # overriding default user model,
EMAIL_HOST = 'internal-mail-router.oracle.com' # default smtp server


DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': 'mysql_db_name',                      # PLEASE CHANGE
        # The following settings are not used with sqlite3:
        'USER': 'mysql_username',  # PLEASE CHANGE
...
SECRET_KEY = 'dm9av(^gt$wm1r^epy=vuppsj*lg*$4y)!2df&pbcga$(ib-+n'
