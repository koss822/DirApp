...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'dirapp_userprofile', (
        ...
        db.send_create_signal(u'dirapp', ['UserProfile'])


    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table(u'dirapp_userprofile')
